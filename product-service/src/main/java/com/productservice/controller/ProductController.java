...
public class ProductController {
    ...
    @GetMapping("/checkQuentity")
    public void checkQuentity(@RequestParam(value = "productId") Long productId,@RequestParam Integer quantity){
        productService.productCheckAndUpdate(productId,quantity);
    }
}
